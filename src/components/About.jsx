		...
		<div className=" flex flex-col md:flex-row justify-between pt-40">
			...
			<div>
				...
				<p className="text-xl mt-5">
					...
					privilege of working at MatraSoft, a start-up, and a
					student-led design studio. My main focus these days is
					building accessible, inclusive products and digital
					experiences for a variety of clients. <br /> I also recently
					completely a course that covers everything you need to build
					a web app with the Restful API using Node & React. <br />
